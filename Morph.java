...
public class Morph {
    ...
    public static Image[] morph(Image original, Grid originalMesh, Image target, Grid targetMesh, final int frames, final String message) {
    ...
    private static Image intermediateMorph(Image original, Grid originalMesh, Image target, Grid targetMesh, float alpha){
        /* Image size */
        int width, height;
